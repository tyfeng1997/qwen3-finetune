#python scripts/create_dpo_datasets.py --dataset_id philschmid/DMath --sample_size 5000 --generation_model_name_or_path tyfeng1997/Qwen3-0.6B-math-orca-qlora-10k-ep1 --num_solutions 4 --batch_size 16 
